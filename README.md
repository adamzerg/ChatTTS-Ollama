...
Based on the source code, added: 
1. ** ollama large model access **, in the experimental folder under the llm.py increased the call ollama class;
2. Added spk_stat.pt file;
3. Just open ttsllm.py run  
